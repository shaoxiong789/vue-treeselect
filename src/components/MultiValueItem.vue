      ...
      return (
        <div class="vue-treeselect__multi-value-item-container">
          <div class={itemClass} onMousedown={this.handleMouseDown}>
            <span class="vue-treeselect__multi-value-label" title={labelRenderer.length > 10 ? labelRenderer : ''} >{ labelRenderer.length > 10 ? `${labelRenderer.slice(0, 10)}...` : labelRenderer }</span>
